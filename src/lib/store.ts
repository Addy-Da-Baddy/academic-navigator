...
const DEFAULT_DATA: AppData = {
  ...
  timetable: {
    MONDAY: [
      { id: generateId(), shortName: 'AI', fullName: 'AI IN CS', time: '08:00-09:00', room: 'AB5-306', startHour: 8, endHour: 9, color: 'blue' },
      { id: generateId(), shortName: 'DM', fullName: 'DATA MINING', time: '09:00-10:00', room: 'AB5-306', startHour: 9, endHour: 10, color: 'green' },
      { id: generateId(), shortName: 'EEFM', fullName: 'Engineering Economics and Financial Management', time: '10:30-11:30', room: 'AB5-306', startHour: 10.5, endHour: 11.5, color: 'yellow' },
      { id: generateId(), shortName: 'OE', fullName: 'Open Elective', time: '11:30-12:30', room: 'AB5-314', startHour: 11.5, endHour: 12.5, color: 'orange' },
      { id: generateId(), shortName: 'MADL', fullName: 'Mobile Application Development Lab', time: '14:00-16:30', room: 'CL-16', startHour: 14, endHour: 16.5, color: 'red' },
    ],
    TUESDAY: [
      { id: generateId(), shortName: 'EH', fullName: 'ETHICAL HACKING', time: '13:00-14:00', room: 'AB5-306', startHour: 13, endHour: 14, color: 'pink' },
      { id: generateId(), shortName: 'NPACN', fullName: 'Network Programming and Advanced Communication Networks', time: '14:00-15:00', room: 'AB5-306', startHour: 14, endHour: 15, color: 'purple' },
    ],
    WEDNESDAY: [
      { id: generateId(), shortName: 'EH', fullName: 'ETHICAL HACKING', time: '08:00-09:00', room: 'AB5-306', startHour: 8, endHour: 9, color: 'pink' },
      { id: generateId(), shortName: 'NPACN', fullName: 'Network Programming and Advanced Communication Networks', time: '09:00-10:00', room: 'AB5-306', startHour: 9, endHour: 10, color: 'purple' },
      { id: generateId(), shortName: 'AI', fullName: 'AI IN CS', time: '10:30-11:30', room: 'AB5-306', startHour: 10.5, endHour: 11.5, color: 'blue' },
      { id: generateId(), shortName: 'DM', fullName: 'DATA MINING', time: '11:30-12:30', room: 'AB5-306', startHour: 11.5, endHour: 12.5, color: 'green' },
    ],
    THURSDAY: [
      { id: generateId(), shortName: 'NDPL', fullName: 'Network Design and Programming Lab', time: '09:00-11:30', room: 'CL-18', startHour: 9, endHour: 11.5, color: 'red' },
      { id: generateId(), shortName: 'EEFM', fullName: 'Engineering Economics and Financial Management', time: '13:00-14:00', room: 'AB5-306', startHour: 13, endHour: 14, color: 'yellow' },
      { id: generateId(), shortName: 'OE', fullName: 'Open Elective', time: '14:00-15:00', room: 'AB5-314', startHour: 14, endHour: 15, color: 'orange' },
    ],
    FRIDAY: [
      { id: generateId(), shortName: 'EEFM', fullName: 'Engineering Economics and Financial Management', time: '08:00-09:00', room: 'AB5-306', startHour: 8, endHour: 9, color: 'yellow' },
      { id: generateId(), shortName: 'OE', fullName: 'Open Elective', time: '09:00-10:00', room: 'AB5-314', startHour: 9, endHour: 10, color: 'orange' },
      { id: generateId(), shortName: 'EH', fullName: 'ETHICAL HACKING', time: '10:30-11:30', room: 'AB5-306', startHour: 10.5, endHour: 11.5, color: 'pink' },
      { id: generateId(), shortName: 'NPACN', fullName: 'Network Programming and Advanced Communication Networks', time: '11:30-12:30', room: 'AB5-306', startHour: 11.5, endHour: 12.5, color: 'purple' },
    ],
    SATURDAY: [
      { id: generateId(), shortName: 'AI', fullName: 'AI IN CS', time: '13:00-14:00', room: 'AB5-306', startHour: 13, endHour: 14, color: 'blue' },
      { id: generateId(), shortName: 'DM', fullName: 'DATA MINING', time: '14:00-15:00', room: 'AB5-306', startHour: 14, endHour: 15, color: 'green' },
      { id: generateId(), shortName: 'NPACN', fullName: 'Network Programming and Advanced Communication Networks', time: '15:00-16:30', room: 'AB5-306', startHour: 15, endHour: 16.5, color: 'purple' },
    ],
  },
  maxSemester: 8,
  targetCGPA: 9.0,
